				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h3 class="alt">Thinking about selling <span class="blackblock"> 2433 23rd Ave?</span> Let us help! Team Fast Agents is YOUR personal team of professionals who makes Real Estate <span class="blueblock">EASY</span> for <span class="greenblock">YOU.</span></h3>
							</header>
							<iframe src="http://mapsengine.google.com/map/embed?mid=zERNb6ZQT6mM.kvWX6H8LeZas" width="80%" height="480"></iframe>
							<h3>Proven Results.</h3>
							<small>Map portrays closed deals January 2013 - December 2013</small>
							<footer>
							...
							<div class="row">
								<div class="4u">
									<article class="item">
										...
										<header>
											<h3><strong>Custom Website Tailored To Your Home</strong></h3>
										</header>
									</article>
									<article class="item">
								...
								<div class="4u">
									...
									<article class="item">
										<iframe class="image full" width="560" height="315" src="//www.youtube.com/embed/4V25c3Ku0bA" frameborder="0" allowfullscreen></iframe>
										<header>
											<h3>Video tours</h3>
										</header>
									</article>
					...
					<section id="about" class="three">
						<div class="container">
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 2433 23rd Ave</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
							...
							<br />
							<a href="http://maxebrdi.paragonrels.com/publink/default.aspx?GUID=a3104375-3a8e-4459-a24d-2575a9da3fff&Report=Yes" class="image full"><img style="width: 100%;" src="images/compdata.jpg" /></a>
						</div>
					</section>
					...
					<section id="contact" class="four">
						...
						<article class="4u ">
							...
							<header>
								...
								<a href="mailto:david.mjre@gmail.com"><span class="small">david@thatoneagent.com</span></a>
							</header>
							<p>
								David prides himself on not just looking for a sale, but looking out for YOU. Building good relationships with his clients comes first for David.
							</p>
						</article>
					</div>
